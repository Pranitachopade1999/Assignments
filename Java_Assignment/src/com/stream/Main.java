...
public class Main {
	...
	public static void main(String[] args) {
		...
		List<News> news = Stream1.getAllNews();
		...
		List<Transaction> transaction = Stream1.getAllTransactions();
